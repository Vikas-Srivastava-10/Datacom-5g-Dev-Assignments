// Purpose - Write a program to demonstrate shared_ptr managing a user-defined class in C++, showing reference counting and automatic destruction when shared_ptr instances go out of scope.
#include <iostream>
#include <memory>
using namespace std;
