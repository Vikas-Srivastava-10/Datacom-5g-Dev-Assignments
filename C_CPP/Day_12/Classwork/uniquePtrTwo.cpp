// Purpose - Write a program to demonstrate transfer of ownership with unique_ptr in C++ using std::move, showing that the original pointer becomes nullptr after the move.
#include <memory>
#include <iostream>
using namespace std;
