// Purpose - Write a program to demonstrate reference counting with shared_ptr in C++, showing how the use count changes as shared_ptr instances are copied and go out of scope.
